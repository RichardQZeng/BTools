...
class WbRunner(tk.Frame):
    def __init__(self, tool_name=None, master=None):
        ...
        tools = open(r'whitebox\flm_tools.json')
    ...
    def create_widgets(self):
        ...
        self.filemenu.add_command(label="Locate BERA Tools exe", command=self.select_exe)
        ...
        self.filemenu.add_command(label="Install a BERA Tools Extension", command=self.install_extension)
        self.filemenu.add_separator()
...
def Runner():
    ...
    wbr._root().wm_iconphoto(False, photo)
